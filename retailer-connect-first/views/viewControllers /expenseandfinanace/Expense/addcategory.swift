...
class addexpensecategory: UIViewController  ,UIDocumentInteractionControllerDelegate, UISearchBarDelegate, UITextFieldDelegate{
    ...
    @IBAction func submit(_ sender: Any) {
        ...
        if(firstT.text?.isEmpty == true
           ...
           secondTextfeild.text?.isEmpty == true
            ...
            designationmodel.addproductcategories(name: firstT.text!, description:secondTextfeild.text!, completion: { result in
                switch result {
    ...
    var designationmodel =  productviewmodel()
