...
//
//  Created by Spark M1 on 02/05/2024.
//
...
class updateemployee:UIViewController, UIScrollViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//                    })
   ...
   showCountryPicker()
    ...
    func Submit(){
        ...
        viewModelUser.aeditEmplioyee(
            image: images.image!, id: String(id ),
    ...
    public func  configuredDropDown(dropDown:DropDown , array:Array<String>){
        ...
        // The lis   print( , to: &<#T##Target#>)t of array to display. Can be changed dynamically
...
extension updateemployee: UITextFieldDelegate {
