...
class branchesviewcontroller: UIViewController , submitdelegate,  UIDocumentInteractionControllerDelegate, updateBranch,deleteBranch{
...
//                                })
    ...
    @IBAction func viewbranches(_ sender: Any) {
        let storyboard = UIStoryboard(name: "branchespage", bundle: nil)
        let initialViewController = storyboard.instantiateViewController(withIdentifier: "viewbranch") as! viewbranches
...
extension branchesviewcontroller: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension branchesviewcontroller: UISearchBarDelegate{
...
extension  branchesviewcontroller: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.id.text = String(currentpostion.id)
