...
//
//  Created by Spark M1 on 25/04/2024.
//
...
class viewsuppliers: UIViewController ,manageSuppliersdelegate , submitdelegate, deletCustomer,UIDocumentInteractionControllerDelegate{
...
//    @IBOutlet weak var uipickerView: UIPickerView!
   @IBOutlet weak var secondTableView: UITableView!
    ...
    func fetchingCustomer(){
        customermodel.FetchingSupplier{ [weak self] result in
            switch result {
            case .success(let user):
...
extension viewsuppliers: UISearchBarDelegate{
...
extension  viewsuppliers: UITableViewDelegate, UITableViewDataSource{
